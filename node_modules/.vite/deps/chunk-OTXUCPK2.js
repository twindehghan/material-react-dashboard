import {
  MenuList_default
} from "./chunk-QBVLPGMJ.js";
import {
  OutlinedInput_default
} from "./chunk-VW3DORGL.js";
import {
  PopoverPaper,
  Popover_default
} from "./chunk-JDF4JBRD.js";
import {
  Input_default
} from "./chunk-ZCCFSG2S.js";
import {
  ArrowDropDown_default,
  filledInputClasses_default,
  getFilledInputUtilityClass
} from "./chunk-PYI6RWPF.js";
import {
  InputBaseComponent,
  InputBaseRoot,
  InputBase_default,
...
var Menu = React2.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime2.jsx)(MenuMenuList, _extends({
...
var _excluded3 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React3.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
    children: [(0, import_jsx_runtime3.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime3.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React4.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime6.jsxs)(React4.Fragment, {
    children: [(0, import_jsx_runtime5.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime5.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime5.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime5.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var _excluded5 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
//# sourceMappingURL=chunk-OTXUCPK2.js.map
